    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NomeAluno', models.CharField(max_length=100, null=True, verbose_name=b'Nome')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('NomeDisciplina', models.IntegerField(null=True, verbose_name=b'nome da disciplina')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('NumeroPeriodo', models.IntegerField(verbose_name=b'numero do per\xc3\xadodo')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('NomeProfessor', models.CharField(max_length=50, null=True, verbose_name=b'Nome do professor')),
            ],
            options={
            },
            bases=(models.Model,),
